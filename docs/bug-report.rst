...
If you encounter any problem when using _DEploid, please file a short bug report by using the `issue tracker <https://github.com/mcveanlab/DEploid/issues>`_
